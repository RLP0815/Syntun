 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144UrlStatus")
public class CrawlerJD144UrlStatusController {
    @Resource(name = "crawlerJD144UrlStatusService")
    CrawlerJD144UrlStatusService crawlerJD144UrlStatusService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144UrlStatus> crawlerJD144UrlStatus = crawlerJD144UrlStatusService.login();
        mv.addObject("crawlerJD144UrlStatus",crawlerJD144UrlStatus);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144UrlStatus> resultMap = crawlerJD144UrlStatusService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144UrlStatusService.getCount(params);
		List<CrawlerJD144UrlStatus> result = crawlerJD144UrlStatusService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlStatusService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlStatusService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlStatusService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlStatusService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlStatus";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlStatus/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144UrlStatus/"+fileName;
