 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144WebError")
public class CrawlerCommentJD144WebErrorController {
    @Resource(name = "crawlerCommentJD144WebErrorService")
    CrawlerCommentJD144WebErrorService crawlerCommentJD144WebErrorService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144WebError> crawlerCommentJD144WebError = crawlerCommentJD144WebErrorService.login();
        mv.addObject("crawlerCommentJD144WebError",crawlerCommentJD144WebError);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144WebError> resultMap = crawlerCommentJD144WebErrorService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144WebErrorService.getCount(params);
		List<CrawlerCommentJD144WebError> result = crawlerCommentJD144WebErrorService.getList(params);
	...
	{
		String urlGroup = request.getParameter("urlGroup");
		String errContentStr = request.getParameter("errContentStr");
		String errContentResult = request.getParameter("errContentResult");
		
		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("urlGroup",urlGroup);
		params.put("errContentStr",errContentStr);
		params.put("errContentResult",errContentResult);

        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144WebErrorService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144WebErrorService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144WebErrorService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144WebErrorService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144WebError";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144WebError/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144WebError/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.web_error", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.web_error", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
