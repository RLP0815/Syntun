 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144UrlList")
public class CrawlerJD144UrlListController {
    @Resource(name = "crawlerJD144UrlListService")
    CrawlerJD144UrlListService crawlerJD144UrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144UrlList> crawlerJD144UrlList = crawlerJD144UrlListService.login();
        mv.addObject("crawlerJD144UrlList",crawlerJD144UrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144UrlList> resultMap = crawlerJD144UrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144UrlListService.getCount(params);
		List<CrawlerJD144UrlList> result = crawlerJD144UrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlList";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlList/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144UrlList/"+fileName;
