 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144UrlStatus")
public class CrawlerTmall144UrlStatusController {
    @Resource(name = "crawlerTmall144UrlStatusService")
    CrawlerTmall144UrlStatusService crawlerTmall144UrlStatusService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144UrlStatus> crawlerTmall144UrlStatus = crawlerTmall144UrlStatusService.login();
        mv.addObject("crawlerTmall144UrlStatus",crawlerTmall144UrlStatus);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144UrlStatus> resultMap = crawlerTmall144UrlStatusService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144UrlStatusService.getCount(params);
		List<CrawlerTmall144UrlStatus> result = crawlerTmall144UrlStatusService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlStatusService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlStatusService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlStatusService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlStatusService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlStatus";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlStatus/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144UrlStatus/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_tmall.init_url_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_tmall.init_url_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
