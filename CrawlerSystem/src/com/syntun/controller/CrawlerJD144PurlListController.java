 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144PurlList")
public class CrawlerJD144PurlListController {
    @Resource(name = "crawlerJD144PurlListService")
    CrawlerJD144PurlListService crawlerJD144PurlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144PurlList> crawlerJD144PurlList = crawlerJD144PurlListService.login();
        mv.addObject("crawlerJD144PurlList",crawlerJD144PurlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144PurlList> resultMap = crawlerJD144PurlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144PurlListService.getCount(params);
		List<CrawlerJD144PurlList> result = crawlerJD144PurlListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144PurlListService.addRecord(paramses);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144PurlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144PurlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144PurlListService.editRecord(paramses);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144PurlList";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144PurlList/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144PurlList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.purl_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.purl_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
