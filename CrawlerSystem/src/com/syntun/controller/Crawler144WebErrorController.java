 ...
 */
@Controller
@RequestMapping(value = "/crawler144WebError")
public class Crawler144WebErrorController {
    @Resource(name = "crawler144WebErrorService")
    Crawler144WebErrorService crawler144WebErrorService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144WebError> crawler144WebError = crawler144WebErrorService.login();
        mv.addObject("crawler144WebError",crawler144WebError);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144WebError> resultMap = crawler144WebErrorService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144WebErrorService.getCount(params);
		List<Crawler144WebError> result = crawler144WebErrorService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144WebErrorService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144WebErrorService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144WebErrorService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144WebErrorService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144WebError";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144WebError/"+fileName;
		//String excelPath = "D:/upload/crawler144WebError/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.web_error", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.web_error", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
