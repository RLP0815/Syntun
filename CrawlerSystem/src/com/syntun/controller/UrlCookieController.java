 ...
 */
@Controller
@RequestMapping(value = "/urlCookie")
public class UrlCookieController {
    @Resource(name = "urlCookieService")
    UrlCookieService urlCookieService;
    ...
    public ModelAndView login()
    {
        ...
        List<UrlCookie> urlCookie = urlCookieService.login();
        mv.addObject("urlCookie",urlCookie);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		List<UrlCookie> resultMap = urlCookieService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = urlCookieService.getCount(params);
		List<UrlCookie> result = urlCookieService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlCookieService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlCookieService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlCookieService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlCookieService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/urlCookie";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/urlCookie/"+fileName;
		//String excelPath = "D:/upload/urlCookie/"+fileName;
		...
		List<String> fieldList132 = BaseDao.getFieldLowerCase("xitong.url_cookie", conn132);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("xitong.url_cookie", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
