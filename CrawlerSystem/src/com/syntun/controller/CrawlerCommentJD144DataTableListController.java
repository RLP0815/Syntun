 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144DataTableList")
public class CrawlerCommentJD144DataTableListController {
    @Resource(name = "crawlerCommentJD144DataTableListService")
    CrawlerCommentJD144DataTableListService crawlerCommentJD144DataTableListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144DataTableList> crawlerCommentJD144DataTableList = crawlerCommentJD144DataTableListService.login();
        mv.addObject("crawlerCommentJD144DataTableList",crawlerCommentJD144DataTableList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144DataTableList> resultMap = crawlerCommentJD144DataTableListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144DataTableListService.getCount(params);
		List<CrawlerCommentJD144DataTableList> result = crawlerCommentJD144DataTableListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableListService.delAllRecord(delList);
	}
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144DataTableList";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144DataTableList/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144DataTableList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.data_table_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.data_table_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
