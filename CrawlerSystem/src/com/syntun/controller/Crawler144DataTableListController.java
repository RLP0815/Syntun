 ...
 */
@Controller
@RequestMapping(value = "/crawler144DataTableList")
public class Crawler144DataTableListController {
    @Resource(name = "crawler144DataTableListService")
    Crawler144DataTableListService crawler144DataTableListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144DataTableList> crawler144DataTableList = crawler144DataTableListService.login();
        mv.addObject("crawler144DataTableList",crawler144DataTableList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144DataTableList> resultMap = crawler144DataTableListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144DataTableListService.getCount(params);
		List<Crawler144DataTableList> result = crawler144DataTableListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableListService.delAllRecord(delList);
	}
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144DataTableList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144DataTableList/"+fileName;
		//String excelPath = "D:/upload/crawler144DataTableList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.data_table_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.data_table_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
