 ...
 */
@Controller
@RequestMapping(value = "/crawler144Url302List")
public class Crawler144Url302ListController {
    @Resource(name = "crawler144Url302ListService")
    Crawler144Url302ListService crawler144Url302ListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144Url302List> crawler144Url302List = crawler144Url302ListService.login();
        mv.addObject("crawler144Url302List",crawler144Url302List);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144Url302List> resultMap = crawler144Url302ListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144Url302ListService.getCount(params);
		List<Crawler144Url302List> result = crawler144Url302ListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144Url302ListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144Url302ListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144Url302ListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144Url302ListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144Url302List";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144Url302List/"+fileName;
		//String excelPath = "D:/upload/crawler144Url302List/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.url302list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.url302list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
