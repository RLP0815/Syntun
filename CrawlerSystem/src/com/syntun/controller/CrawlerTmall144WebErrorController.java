 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144WebError")
public class CrawlerTmall144WebErrorController {
    @Resource(name = "crawlerTmall144WebErrorService")
    CrawlerTmall144WebErrorService crawlerTmall144WebErrorService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144WebError> crawlerTmall144WebError = crawlerTmall144WebErrorService.login();
        mv.addObject("crawlerTmall144WebError",crawlerTmall144WebError);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144WebError> resultMap = crawlerTmall144WebErrorService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144WebErrorService.getCount(params);
		List<CrawlerTmall144WebError> result = crawlerTmall144WebErrorService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144WebErrorService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144WebErrorService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144WebErrorService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144WebErrorService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144WebError";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144WebError/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144WebError/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_tmall.web_error", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_tmall.web_error", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
