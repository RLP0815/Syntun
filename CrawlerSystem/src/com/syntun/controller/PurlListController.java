 ...
 */
@Controller
@RequestMapping(value = "/purlList")
public class PurlListController {
    @Resource(name = "purlListService")
    PurlListService purlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<PurlList> purlList = purlListService.login();
        mv.addObject("purlList",purlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		List<PurlList> resultMap = purlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = purlListService.getCount(params);
		List<PurlList> result = purlListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		purlListService.addRecord(paramses);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		purlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		purlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		purlListService.editRecord(paramses);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/purlList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/purlList/"+fileName;
		//String excelPath = "D:/upload/purlList/"+fileName;
		...
		List<String> fieldList132 = BaseDao.getFieldLowerCase("xitong.purl_list", conn132);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("xitong.purl_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
