 ...
 */
@Controller
@RequestMapping(value = "/crawler144PurlList")
public class Crawler144PurlListController {
    @Resource(name = "crawler144PurlListService")
    Crawler144PurlListService crawler144PurlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144PurlList> crawler144PurlList = crawler144PurlListService.login();
        mv.addObject("crawler144PurlList",crawler144PurlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144PurlList> resultMap = crawler144PurlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144PurlListService.getCount(params);
		List<Crawler144PurlList> result = crawler144PurlListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144PurlListService.addRecord(paramses);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144PurlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144PurlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144PurlListService.editRecord(paramses);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144PurlList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144PurlList/"+fileName;
		//String excelPath = "D:/upload/crawler144PurlList/"+fileName;
