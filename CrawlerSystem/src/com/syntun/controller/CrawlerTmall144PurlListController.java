 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144PurlList")
public class CrawlerTmall144PurlListController {
    @Resource(name = "crawlerTmall144PurlListService")
    CrawlerTmall144PurlListService crawlerTmall144PurlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144PurlList> crawlerTmall144PurlList = crawlerTmall144PurlListService.login();
        mv.addObject("crawlerTmall144PurlList",crawlerTmall144PurlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144PurlList> resultMap = crawlerTmall144PurlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144PurlListService.getCount(params);
		List<CrawlerTmall144PurlList> result = crawlerTmall144PurlListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144PurlListService.addRecord(paramses);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144PurlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144PurlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144PurlListService.editRecord(paramses);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144PurlList";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144PurlList/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144PurlList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_tmall.purl_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_tmall.purl_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
