 ...
 */
@Controller
@RequestMapping(value = "/urlLimitList")
public class UrlLimitListController {
    @Resource(name = "urlLimitListService")
    UrlLimitListService urlLimitListService;
    ...
    public ModelAndView login()
    {
        ...
        List<UrlLimitList> urlLimitList = urlLimitListService.login();
        mv.addObject("urlLimitList",urlLimitList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		List<UrlLimitList> resultMap = urlLimitListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = urlLimitListService.getCount(params);
		List<UrlLimitList> result = urlLimitListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String isDns = request.getParameter("isDns");
		...
		params.put("isDns",isDns);

		DataSourceContextHolder.setDbType("ds_mop");  
		urlLimitListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlLimitListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlLimitListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		urlLimitListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/urlLimitList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/urlLimitList/"+fileName;
		//String excelPath = "D:/upload/urlLimitList/"+fileName;
		...
		List<String> fieldList132 = BaseDao.getFieldLowerCase("xitong.url_limit_list", conn132);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("xitong.url_limit_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
