 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144UrlStatus")
public class CrawlerCommentJD144UrlStatusController {
    @Resource(name = "crawlerCommentJD144UrlStatusService")
    CrawlerCommentJD144UrlStatusService crawlerCommentJD144UrlStatusService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144UrlStatus> crawlerCommentJD144UrlStatus = crawlerCommentJD144UrlStatusService.login();
        mv.addObject("crawlerCommentJD144UrlStatus",crawlerCommentJD144UrlStatus);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144UrlStatus> resultMap = crawlerCommentJD144UrlStatusService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144UrlStatusService.getCount(params);
		List<CrawlerCommentJD144UrlStatus> result = crawlerCommentJD144UrlStatusService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
		...
		String parseTime = request.getParameter("parseTime");
		String isParseOver = request.getParameter("isParseOver");
		String tryNum = request.getParameter("tryNum");
		String urlMd5 = request.getParameter("urlMd5");
		String insertBatchNum = request.getParameter("insertBatchNum");
		String sortId = request.getParameter("sortId");
		
		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("addTime",addTime);
		params.put("getTime",getTime);
		params.put("parseTime",parseTime);
		params.put("isParseOver",isParseOver);
		params.put("tryNum",tryNum);
		params.put("urlMd5",urlMd5);
		params.put("insertBatchNum",insertBatchNum);
		params.put("sortId",sortId);

        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlStatusService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlStatusService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlStatusService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlStatusService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlStatus";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlStatus/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144UrlStatus/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.init_url_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.init_url_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
