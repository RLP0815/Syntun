 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144DataTableList")
public class CrawlerJD144DataTableListController {
    @Resource(name = "crawlerJD144DataTableListService")
    CrawlerJD144DataTableListService crawlerJD144DataTableListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144DataTableList> crawlerJD144DataTableList = crawlerJD144DataTableListService.login();
        mv.addObject("crawlerJD144DataTableList",crawlerJD144DataTableList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144DataTableList> resultMap = crawlerJD144DataTableListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144DataTableListService.getCount(params);
		List<CrawlerJD144DataTableList> result = crawlerJD144DataTableListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableListService.delAllRecord(delList);
	}
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144DataTableList";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144DataTableList/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144DataTableList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.data_table_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.data_table_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
