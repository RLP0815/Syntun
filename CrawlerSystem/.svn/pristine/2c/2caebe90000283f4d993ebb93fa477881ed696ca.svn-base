 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144UrlList")
public class CrawlerCommentJD144UrlListController {
    @Resource(name = "crawlerCommentJD144UrlListService")
    CrawlerCommentJD144UrlListService crawlerCommentJD144UrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144UrlList> crawlerCommentJD144UrlList = crawlerCommentJD144UrlListService.login();
        mv.addObject("crawlerCommentJD144UrlList",crawlerCommentJD144UrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144UrlList> resultMap = crawlerCommentJD144UrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144UrlListService.getCount(params);
		List<CrawlerCommentJD144UrlList> result = crawlerCommentJD144UrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
		...
		String fatherUrl = request.getParameter("fatherUrl");
		...
		params.put("fatherUrl",fatherUrl);
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlList";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlList/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144UrlList/"+fileName;
