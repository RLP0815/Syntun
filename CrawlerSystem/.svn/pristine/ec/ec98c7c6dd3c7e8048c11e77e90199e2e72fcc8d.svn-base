	    ...
	    <div class="layui-tab-item">
	    	<blockquote class="layui-elem-quote quoteBox">
				<div class="layui-inline">
					...
					<!-- <a class="layui-btn layui-btn-normal tmall_btn" data-type="reload">天猫特殊促销</a> -->
				</div>	
			</blockquote>
...
<div id="tmallFiled" style="display:none;">
	<form class="layui-form" style="width:95%;">
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">文件路径</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input excelPath" lay-verify="required" placeholder="请输入文件路径">
			</div>
		</div>
		
		<div class="layui-form-item layui-row layui-col-xs12">
			<div class="layui-input-block">
				<button class="layui-btn layui-btn-sm tmallExcel" lay-submit="" lay-filter="tmallExcel">立即执行</button>
			</div>
		</div>
