 ...
 */
@Controller
@RequestMapping(value = "/crawler144UrlList")
public class Crawler144UrlListController {
    @Resource(name = "crawler144UrlListService")
    Crawler144UrlListService crawler144UrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144UrlList> crawler144UrlList = crawler144UrlListService.login();
        mv.addObject("crawler144UrlList",crawler144UrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144UrlList> resultMap = crawler144UrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144UrlListService.getCount(params);
		List<Crawler144UrlList> result = crawler144UrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144UrlList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144UrlList/"+fileName;
		//String excelPath = "D:/upload/crawler144UrlList/"+fileName;
