 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144WebError")
public class CrawlerJD144WebErrorController {
    @Resource(name = "crawlerJD144WebErrorService")
    CrawlerJD144WebErrorService crawlerJD144WebErrorService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144WebError> crawlerJD144WebError = crawlerJD144WebErrorService.login();
        mv.addObject("crawlerJD144WebError",crawlerJD144WebError);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144WebError> resultMap = crawlerJD144WebErrorService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144WebErrorService.getCount(params);
		List<CrawlerJD144WebError> result = crawlerJD144WebErrorService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144WebErrorService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144WebErrorService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144WebErrorService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144WebErrorService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144WebError";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144WebError/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144WebError/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.web_error", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.web_error", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
