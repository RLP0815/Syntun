 ...
 */
@Controller
@RequestMapping(value = "/filterUrl")
public class FilterUrlController {
    ...
    public ModelAndView login()
    {
        ...
        List<FilterUrl> filterUrl = filterUrlService.login();
        mv.addObject("filterUrl",filterUrl);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		params.put("urlStr",urlGroup);

		DataSourceContextHolder.setDbType("ds_mop");  
		List<FilterUrl> resultMap = filterUrlService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = filterUrlService.getCount(params);
		List<FilterUrl> result = filterUrlService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		filterUrlService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		filterUrlService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		filterUrlService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		filterUrlService.editRecord(params);
	}
	
	@RequestMapping(value = "/getKeyValueList")
	public void getKeyValueList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
    	int page = Integer.parseInt(request.getParameter("page"));
    	int limit = Integer.parseInt(request.getParameter("limit"));
    	int start = (page-1)*limit;
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = filterUrlService.getKeyValueCount(params);
		List<FilterUrl> result = filterUrlService.getKeyValueList(params);
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/filterUrl";
		//String path = "D:/upload/filterUrl";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/filterUrl/"+fileName;
		//String excelPath = "D:/upload/filterUrl/"+fileName;
		...
		List<String> fieldList132 = BaseDao.getFieldLowerCase("xitong.filter_url", conn132);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("xitong.filter_url", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
