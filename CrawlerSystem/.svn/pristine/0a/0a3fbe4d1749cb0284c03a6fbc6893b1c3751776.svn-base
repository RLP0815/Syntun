...
public class ProductUrlController {
    @Resource(name = "productUrlService")
    ...
    public ModelAndView login()
    {
        ...
        List<ProductUrl> productUrl = productUrlService.login();
        mv.addObject("productUrl",productUrl);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		List<ProductUrl> resultMap = productUrlService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		int count = productUrlService.getCount(params);
		List<ProductUrl> result = productUrlService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		productUrlService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		productUrlService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		productUrlService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		DataSourceContextHolder.setDbType("ds_mop");  
		productUrlService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/productUrl";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/productUrl/"+fileName;
		//String excelPath = "D:/upload/productUrl/"+fileName;
		...
		List<String> fieldList132 = BaseDao.getFieldLowerCase("xitong.product_url", conn132);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("xitong.product_url", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
