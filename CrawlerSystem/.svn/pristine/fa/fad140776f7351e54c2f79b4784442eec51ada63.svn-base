 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144UrlCookie")
public class CrawlerTmall144UrlCookieController {
    @Resource(name = "crawlerTmall144UrlCookieService")
    CrawlerTmall144UrlCookieService crawlerTmall144UrlCookieService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144UrlCookie> crawlerTmall144UrlCookie = crawlerTmall144UrlCookieService.login();
        mv.addObject("crawlerTmall144UrlCookie",crawlerTmall144UrlCookie);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144UrlCookie> resultMap = crawlerTmall144UrlCookieService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144UrlCookieService.getCount(params);
		List<CrawlerTmall144UrlCookie> result = crawlerTmall144UrlCookieService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlCookieService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlCookieService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlCookieService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlCookieService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlCookie";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlCookie/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144UrlCookie/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_tmall.url_cookie", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_tmall.url_cookie", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
