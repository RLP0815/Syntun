 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144UrlCookie")
public class CrawlerCommentJD144UrlCookieController {
    @Resource(name = "crawlerCommentJD144UrlCookieService")
    CrawlerCommentJD144UrlCookieService crawlerCommentJD144UrlCookieService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144UrlCookie> crawlerCommentJD144UrlCookie = crawlerCommentJD144UrlCookieService.login();
        mv.addObject("crawlerCommentJD144UrlCookie",crawlerCommentJD144UrlCookie);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		params.put("cookieStr",cookieStr);

        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144UrlCookie> resultMap = crawlerCommentJD144UrlCookieService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144UrlCookieService.getCount(params);
		List<CrawlerCommentJD144UrlCookie> result = crawlerCommentJD144UrlCookieService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlCookieService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlCookieService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlCookieService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144UrlCookieService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlCookie";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144UrlCookie/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144UrlCookie/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.url_cookie", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.url_cookie", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
