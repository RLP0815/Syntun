...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入url_cookie" />
					</div>
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>url_cookie_list说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">url_cookie</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input urlCookie" lay-verify="required" placeholder="请输入url_cookie">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<script type="text/javascript" src="UrlCookieList.js"></script>
</body>
</html>