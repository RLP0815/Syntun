 ...
 */
@Controller
@RequestMapping(value = "/crawler144UrlCookie")
public class Crawler144UrlCookieController {
    @Resource(name = "crawler144UrlCookieService")
    Crawler144UrlCookieService crawler144UrlCookieService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144UrlCookie> crawler144UrlCookie = crawler144UrlCookieService.login();
        mv.addObject("crawler144UrlCookie",crawler144UrlCookie);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144UrlCookie> resultMap = crawler144UrlCookieService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144UrlCookieService.getCount(params);
		List<Crawler144UrlCookie> result = crawler144UrlCookieService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlCookieService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlCookieService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlCookieService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlCookieService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144UrlCookie";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144UrlCookie/"+fileName;
		//String excelPath = "D:/upload/crawler144UrlCookie/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.url_cookie", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.url_cookie", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
