 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144PurlList")
public class CrawlerCommentJD144PurlListController {
    @Resource(name = "crawlerCommentJD144PurlListService")
    CrawlerCommentJD144PurlListService crawlerCommentJD144PurlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144PurlList> crawlerCommentJD144PurlList = crawlerCommentJD144PurlListService.login();
        mv.addObject("crawlerCommentJD144PurlList",crawlerCommentJD144PurlList);
	...
	{
    	String purlStr = request.getParameter("purlStr");
    	HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("purlStr",purlStr);

        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144PurlList> resultMap = crawlerCommentJD144PurlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144PurlListService.getCount(params);
		List<CrawlerCommentJD144PurlList> result = crawlerCommentJD144PurlListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String exeParams = request.getParameter("exeParams");
		String patternId = request.getParameter("patternId");
		String parentPurlId = request.getParameter("parentPurlId");
		...
		paramses.put("purlStr",purlStr);
		paramses.put("params",params);
		paramses.put("exeParams",exeParams);
		paramses.put("patternId",patternId);
		paramses.put("parentPurlId",parentPurlId);
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144PurlListService.addRecord(paramses);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144PurlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144PurlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144PurlListService.editRecord(paramses);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144PurlList";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144PurlList/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144PurlList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.purl_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.purl_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
