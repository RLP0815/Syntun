...
<input  id="ctx" style="display:none" value="${pageContext.request.contextPath}">
	...
	<div class="layui-row layui-col-space25 panel_box">
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;" data-url="page/syntun/command/systemLog.jsp">
				<div class="panel_icon layui-bg-green">
					<span>日志1</span>
				</div>
				<div class="panel_word">
					<span>系统日志</span>
					<cite class="layui-hide">系统日志</cite>
				</div>
			</a>
		</div>
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;" data-url="page/syntun/command/remoteFile.jsp">
				<div class="panel_icon layui-bg-black">
					<span>日志2</span>
				</div>
				<div class="panel_word">
					<span>操作日志</span>
					<cite class="layui-hide">操作日志</cite>
				</div>
			</a>
		</div>
<!-- 		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;" data-url="page/syntun/crawler/FilterUrl.jsp">
				<div class="panel_icon layui-bg-green">
					<span>表3</span>
				</div>
				<div class="panel_word">
					<span>filter_url</span>
					<cite class="layui-hide">filter_url</cite>
				</div>
			</a>
		</div>
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
