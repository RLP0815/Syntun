	...
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input cateId" lay-verify="required" placeholder="请输入用户登录名">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<!-- 		<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input user_name" lay-verify="required" placeholder="姓名">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<script type="text/javascript" src="userManageRoom.js"></script>
</body>
</html>