 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144UrlCookie")
public class CrawlerJD144UrlCookieController {
    @Resource(name = "crawlerJD144UrlCookieService")
    CrawlerJD144UrlCookieService crawlerJD144UrlCookieService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144UrlCookie> crawlerJD144UrlCookie = crawlerJD144UrlCookieService.login();
        mv.addObject("crawlerJD144UrlCookie",crawlerJD144UrlCookie);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144UrlCookie> resultMap = crawlerJD144UrlCookieService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144UrlCookieService.getCount(params);
		List<CrawlerJD144UrlCookie> result = crawlerJD144UrlCookieService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlCookieService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlCookieService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlCookieService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144UrlCookieService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlCookie";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144UrlCookie/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144UrlCookie/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.url_cookie", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.url_cookie", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
