 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144InitUrlList")
public class CrawlerCommentJD144InitUrlListController {
    @Resource(name = "crawlerCommentJD144InitUrlListService")
    CrawlerCommentJD144InitUrlListService crawlerCommentJD144InitUrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144InitUrlList> crawlerCommentJD144InitUrlList = crawlerCommentJD144InitUrlListService.login();
        mv.addObject("crawlerCommentJD144InitUrlList",crawlerCommentJD144InitUrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144InitUrlList> resultMap = crawlerCommentJD144InitUrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144InitUrlListService.getCount(params);
		List<CrawlerCommentJD144InitUrlList> result = crawlerCommentJD144InitUrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144InitUrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144InitUrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144InitUrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144InitUrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144InitUrlList";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144InitUrlList/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144InitUrlList/"+fileName;
