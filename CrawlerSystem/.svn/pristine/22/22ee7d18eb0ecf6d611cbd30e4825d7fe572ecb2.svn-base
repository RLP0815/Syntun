 ...
 */
@Controller
@RequestMapping(value = "/crawler144UrlStatus")
public class Crawler144UrlStatusController {
    @Resource(name = "crawler144UrlStatusService")
    Crawler144UrlStatusService crawler144UrlStatusService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144UrlStatus> crawler144UrlStatus = crawler144UrlStatusService.login();
        mv.addObject("crawler144UrlStatus",crawler144UrlStatus);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144UrlStatus> resultMap = crawler144UrlStatusService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144UrlStatusService.getCount(params);
		List<Crawler144UrlStatus> result = crawler144UrlStatusService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlStatusService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlStatusService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlStatusService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144UrlStatusService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144UrlStatus";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144UrlStatus/"+fileName;
		//String excelPath = "D:/upload/crawler144UrlStatus/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.init_url_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.init_url_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
