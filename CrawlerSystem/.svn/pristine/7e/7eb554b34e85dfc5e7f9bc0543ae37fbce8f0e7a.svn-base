 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144Url302List")
public class CrawlerTmall144Url302ListController {
    @Resource(name = "crawlerTmall144Url302ListService")
    CrawlerTmall144Url302ListService crawlerTmall144Url302ListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144Url302List> crawlerTmall144Url302List = crawlerTmall144Url302ListService.login();
        mv.addObject("crawlerTmall144Url302List",crawlerTmall144Url302List);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144Url302List> resultMap = crawlerTmall144Url302ListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144Url302ListService.getCount(params);
		List<CrawlerTmall144Url302List> result = crawlerTmall144Url302ListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144Url302ListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144Url302ListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144Url302ListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144Url302ListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144Url302List";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144Url302List/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144Url302List/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_tmall.url302list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_tmall.url302list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
