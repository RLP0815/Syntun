 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144Url302List")
public class CrawlerJD144Url302ListController {
    @Resource(name = "crawlerJD144Url302ListService")
    CrawlerJD144Url302ListService crawlerJD144Url302ListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144Url302List> crawlerJD144Url302List = crawlerJD144Url302ListService.login();
        mv.addObject("crawlerJD144Url302List",crawlerJD144Url302List);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144Url302List> resultMap = crawlerJD144Url302ListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144Url302ListService.getCount(params);
		List<CrawlerJD144Url302List> result = crawlerJD144Url302ListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144Url302ListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144Url302ListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144Url302ListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144Url302ListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144Url302List";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144Url302List/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144Url302List/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.url302list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.url302list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
