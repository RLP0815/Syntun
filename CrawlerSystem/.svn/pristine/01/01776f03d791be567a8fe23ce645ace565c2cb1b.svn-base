 ...
 */
@Controller
@RequestMapping(value = "/crawlerCommentJD144DataTableFiledList")
public class CrawlerCommentJD144DataTableFiledListController {
    @Resource(name = "crawlerCommentJD144DataTableFiledListService")
    CrawlerCommentJD144DataTableFiledListService crawlerCommentJD144DataTableFiledListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerCommentJD144DataTableFiledList> crawlerCommentJD144DataTableFiledList = crawlerCommentJD144DataTableFiledListService.login();
        mv.addObject("crawlerCommentJD144DataTableFiledList",crawlerCommentJD144DataTableFiledList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		List<CrawlerCommentJD144DataTableFiledList> resultMap = crawlerCommentJD144DataTableFiledListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		int count = crawlerCommentJD144DataTableFiledListService.getCount(params);
		List<CrawlerCommentJD144DataTableFiledList> result = crawlerCommentJD144DataTableFiledListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableFiledListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableFiledListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableFiledListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerCommentJD");
		crawlerCommentJD144DataTableFiledListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144DataTableFiledList";
		...
		String excelPath = "/home/CrawlerCommentJDSystem/uplodExcel/crawlerCommentJD144DataTableFiledList/"+fileName;
		//String excelPath = "D:/upload/crawlerCommentJD144DataTableFiledList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_comment_Jd.data_table_filed_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_comment_Jd.data_table_filed_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
