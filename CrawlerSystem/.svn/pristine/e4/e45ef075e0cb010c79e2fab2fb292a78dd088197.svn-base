 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144InitUrlList")
public class CrawlerTmall144InitUrlListController {
    @Resource(name = "crawlerTmall144InitUrlListService")
    CrawlerTmall144InitUrlListService crawlerTmall144InitUrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144InitUrlList> crawlerTmall144InitUrlList = crawlerTmall144InitUrlListService.login();
        mv.addObject("crawlerTmall144InitUrlList",crawlerTmall144InitUrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144InitUrlList> resultMap = crawlerTmall144InitUrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144InitUrlListService.getCount(params);
		List<CrawlerTmall144InitUrlList> result = crawlerTmall144InitUrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144InitUrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144InitUrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144InitUrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144InitUrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144InitUrlList";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144InitUrlList/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144InitUrlList/"+fileName;
