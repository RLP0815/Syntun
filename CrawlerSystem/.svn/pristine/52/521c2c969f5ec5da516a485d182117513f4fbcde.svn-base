...
<div class="layui-tab layui-tab-brief">
	<div class="layui-col-md12 layui-col-xs12">
			...
			<div class="layui-inline">
				<div class="demoTable">
					<div class="layui-input-inline">
							...
							<div class="layui-input-inline">
								<input type="text" class="layui-input url" id="tableWhere"  placeholder="请输入URL" />
							</div>
					</div>
		...
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
   	 		<legend>shop_product_price_list列表</legend>
		</fieldset>
		<table id="filedList2" lay-filter="filedList2"></table>
		
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    		<legend>promotion_info列表</legend>
		</fieldset>
...
var str = "";
    ...
    layui.use(['element','form','layer','table','laytpl'],function(){
        ...
        $(".search_btn").on("click",function(){
        	var tableUrl = $("#tableWhere").val();
        	if(tableUrl==''){
        		top.layer.msg("请输入URL！");
        		return false;
        	}
		    //替换字段列表
		     var tableIns = table.render({
		        elem: '#filedList',
		        url :$("#ctx").attr("value") + '/platformClassify/getPromotionInfo',
                where: {
                	tableUrl: $("#tableWhere").val()  //搜索的关键字
                },
		        cellMinWidth : 95,
		        //page : true,
		        //height : "full-68",
		        ...
		        cols : [[
		                 {type: 'numbers', width:30, fixed: 'left'},
		                 {field: "promotion_type_name", title: "promotion_type_name", align:"center", minWidth:100},
		                 {field: "promotion_type_info", title: "promotion_type_info", align:"center", minWidth:150},
		                 {field: "operation_product_id", title: "operation_product_id", align:"center", minWidth:150},
		                 {field: "platform_id", title: "platform_id", align:"center", minWidth:100},
		                 {field: "hour", title: "hour", align:"center", minWidth:50},
		                 {field: "min", title: "min", align:"center", minWidth:50},
		                 {field: "get_date", title: "get_date", align:"center", minWidth:150},
		                 {field: "shop_code", title: "shop_code", align:"center", minWidth:150},
		                 {field: "sku_id", title: "sku_id", align:"center", minWidth:100},
		               ]]
		    }); 
			    //替换字段列表
		     var tableIns = table.render({
		        elem: '#filedList2',
		        url :$("#ctx").attr("value") + '/platformClassify/getShopProductPriceList',
		        cellMinWidth : 95,
                where: {
                	tableUrl: $("#tableWhere").val()  //搜索的关键字
                },
		        ...
		        cols : [[
		                 {type: 'numbers', width:30, fixed: 'left'},
		                 {field: "product_price", title: "product_price", align:"center", minWidth:100},
		                 {field: "promotion_price", title: "promotion_price", align:"center", minWidth:150},
		                 {field: "operation_product_id", title: "operation_product_id", align:"center", minWidth:150},
		                 {field: "platform_id", title: "platform_id", align:"center", minWidth:100},
		                 {field: "hour", title: "hour", align:"center", minWidth:50},
		                 {field: "min", title: "min", align:"center", minWidth:50},
