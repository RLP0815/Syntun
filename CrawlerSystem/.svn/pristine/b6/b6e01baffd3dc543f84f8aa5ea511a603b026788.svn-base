 ...
 */
@Controller
@RequestMapping(value = "/crawlerTmall144UrlList")
public class CrawlerTmall144UrlListController {
    @Resource(name = "crawlerTmall144UrlListService")
    CrawlerTmall144UrlListService crawlerTmall144UrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerTmall144UrlList> crawlerTmall144UrlList = crawlerTmall144UrlListService.login();
        mv.addObject("crawlerTmall144UrlList",crawlerTmall144UrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		List<CrawlerTmall144UrlList> resultMap = crawlerTmall144UrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		int count = crawlerTmall144UrlListService.getCount(params);
		List<CrawlerTmall144UrlList> result = crawlerTmall144UrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerTmall");
		crawlerTmall144UrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlList";
		...
		String excelPath = "/home/CrawlerTmallSystem/uplodExcel/crawlerTmall144UrlList/"+fileName;
		//String excelPath = "D:/upload/crawlerTmall144UrlList/"+fileName;
