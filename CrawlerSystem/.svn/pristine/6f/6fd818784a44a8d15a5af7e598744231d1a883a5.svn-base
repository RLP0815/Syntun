 ...
 */
@Controller
@RequestMapping(value = "/crawlerJD144DataTableFiledList")
public class CrawlerJD144DataTableFiledListController {
    @Resource(name = "crawlerJD144DataTableFiledListService")
    CrawlerJD144DataTableFiledListService crawlerJD144DataTableFiledListService;
    ...
    public ModelAndView login()
    {
        ...
        List<CrawlerJD144DataTableFiledList> crawlerJD144DataTableFiledList = crawlerJD144DataTableFiledListService.login();
        mv.addObject("crawlerJD144DataTableFiledList",crawlerJD144DataTableFiledList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		List<CrawlerJD144DataTableFiledList> resultMap = crawlerJD144DataTableFiledListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		int count = crawlerJD144DataTableFiledListService.getCount(params);
		List<CrawlerJD144DataTableFiledList> result = crawlerJD144DataTableFiledListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableFiledListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableFiledListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableFiledListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawlerJD");
		crawlerJD144DataTableFiledListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144DataTableFiledList";
		...
		String excelPath = "/home/CrawlerJDSystem/uplodExcel/crawlerJD144DataTableFiledList/"+fileName;
		//String excelPath = "D:/upload/crawlerJD144DataTableFiledList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler_jd.data_table_filed_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler_jd.data_table_filed_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
