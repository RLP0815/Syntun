 ...
 */
@Controller
@RequestMapping(value = "/crawler144DataTableFiledList")
public class Crawler144DataTableFiledListController {
    @Resource(name = "crawler144DataTableFiledListService")
    Crawler144DataTableFiledListService crawler144DataTableFiledListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144DataTableFiledList> crawler144DataTableFiledList = crawler144DataTableFiledListService.login();
        mv.addObject("crawler144DataTableFiledList",crawler144DataTableFiledList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144DataTableFiledList> resultMap = crawler144DataTableFiledListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144DataTableFiledListService.getCount(params);
		List<Crawler144DataTableFiledList> result = crawler144DataTableFiledListService.getList(params);
	...
	public void addRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableFiledListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableFiledListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableFiledListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144DataTableFiledListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144DataTableFiledList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144DataTableFiledList/"+fileName;
		//String excelPath = "D:/upload/crawler144DataTableFiledList/"+fileName;
		...
		List<String> fieldList144 = BaseDao.getFieldLowerCase("crawler.data_table_filed_list", conn144);
	    ...
	    if (list != null) {
	    	...
	    	if(excelData.size()!=0){
		    	for(HashMap<String, String> shopMap : excelData){
		    		String sql = ConvertSql.getSql("crawler.data_table_filed_list", fieldList, shopMap);
		    		dataTatal.add(sql);
		    	}
