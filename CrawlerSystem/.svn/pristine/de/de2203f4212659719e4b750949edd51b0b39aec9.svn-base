 ...
 */
@Controller
@RequestMapping(value = "/crawler144InitUrlList")
public class Crawler144InitUrlListController {
    @Resource(name = "crawler144InitUrlListService")
    Crawler144InitUrlListService crawler144InitUrlListService;
    ...
    public ModelAndView login()
    {
        ...
        List<Crawler144InitUrlList> crawler144InitUrlList = crawler144InitUrlListService.login();
        mv.addObject("crawler144InitUrlList",crawler144InitUrlList);
	...
	public void getAllList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		List<Crawler144InitUrlList> resultMap = crawler144InitUrlListService.getAllList(params);
	...
	public void getList(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		int count = crawler144InitUrlListService.getCount(params);
		List<Crawler144InitUrlList> result = crawler144InitUrlListService.getList(params);
...
//		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144InitUrlListService.addRecord(params);
	...
	public void delRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144InitUrlListService.delRecord(params);
	...
	public void delAllRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144InitUrlListService.delAllRecord(delList);
	...
	public void editRecord(HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
        ...
        DataSourceContextHolder.setDbType("ds_144crawler");
		crawler144InitUrlListService.editRecord(params);
	}
    ...
    public JSONObject upload(MultipartFile file, HttpServletRequest servletRequest) throws IOException { 
		...
		String path = "/home/CrawlerSystem/uplodExcel/crawler144InitUrlList";
		...
		String excelPath = "/home/CrawlerSystem/uplodExcel/crawler144InitUrlList/"+fileName;
		//String excelPath = "D:/upload/crawler144InitUrlList/"+fileName;
