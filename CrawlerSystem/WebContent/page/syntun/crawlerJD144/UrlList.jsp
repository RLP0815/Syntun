...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input urlMd5" lay-verify="required" placeholder="请输入url_md5">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">father_url</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input fatherUrl" lay-verify="required" placeholder="请输入father_url">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<script type="text/javascript" src="UrlList.js"></script>
</body>
</html>