...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入cookie_str" />
					</div>
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>url_cookie说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">cookie_str</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input cookieStr" lay-verify="required" placeholder="请输入cookie_str">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<script type="text/javascript" src="UrlCookie.js"></script>
</body>
</html>