...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">table_name</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input tableName" lay-verify="required" placeholder="请输入table_name">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12 insertOracleTime1">
			<label class="layui-form-label">insert_oracle_time</label>
			<div class="layui-input-block">
	    		<input class="layui-input insertOracleTime" lay-verify="datetime" placeholder="yyyy-MM-dd HH:mm:ss" type="text">
	    	</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">rowkey_filed</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input rowkeyFiled" lay-verify="required" placeholder="请输入rowkey_filed">
			</div>
		</div>
...
<script type="text/javascript" src="DataTableList.js"></script>
</body>
</html>