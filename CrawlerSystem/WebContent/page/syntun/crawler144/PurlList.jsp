...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input purlStr" lay-verify="required" placeholder="请输入url_str">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">params</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input params" lay-verify="required" placeholder="请输入params">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">exe_params</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input exeParams" lay-verify="required" placeholder="请输入exe_params">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">pattern_id</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input patternId" lay-verify="required" placeholder="请输入pattern_id">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">parent_purl_id</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input parentPurlId" lay-verify="required" placeholder="请输入parent_purl_id">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input generateSortId" lay-verify="required|number" placeholder="请输入generate_sort_id(只能是数字)">
			</div>
		</div>
...
<script type="text/javascript" src="PurlList.js"></script>
</body>
</html>