...
<div class="layui-tab layui-tab-brief">
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>url302list说明</blockquote>
...
<script type="text/javascript" src="Url302List.js"></script>
</body>
</html>