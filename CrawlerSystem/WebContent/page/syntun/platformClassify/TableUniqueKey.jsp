...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入表名" />
					</div>
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>表格唯一键维护说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" lay-filter="filter" style="width:95%;">
...
<script type="text/javascript" src="TableUniqueKey.js"></script>
</body>
</html>