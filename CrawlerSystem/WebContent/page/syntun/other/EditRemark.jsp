			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="" class="searchVal" lay-filter="">
						...
						<option value="dataTableFiled">data_table_filed</option>
						<option value="dataTable">data_table</option>
						<option value="filterUrl">filter_url</option>
						<option value="initUrlList">init_url_list</option>
						<option value="productUrl">product_url</option>
						<option value="purlList">purl_list</option>
						<option value="replaceStr">replace_str</option>
						<option value="urlCookie">url_cookie</option>
						<option value="urlCookieList">url_cookie_list</option>
						<option value="urlLimitList">url_limit_list</option>
						<option value="url302list">url302list</option>
						<option value="webError">web_error</option>
