...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入replace_str" />
					</div>
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>replace_str说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">replace_group</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input replaceGroup" lay-verify="required|number" placeholder="请输入replace_group(只能是数字)">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">replace_str</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input replaceStr" lay-verify="required" placeholder="请输入replace_str">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">replace_val</label>
			<div class="layui-input-block">
	    		<input class="layui-input replaceVal" lay-verify="required" placeholder="请输入replace_val">
	    	</div>
		</div>
...
<script type="text/javascript" src="ReplaceStr.js"></script>
</body>
</html>