...
<div class="layui-tab layui-tab-brief">
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>url_limit_list说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input status" lay-verify="required|number" placeholder="请输入status(只能是数字)">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">interval_time</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input intervalTime" lay-verify="required|number" placeholder="请输入interval_time(只能是数字)">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">is_dns</label>
			<div class="layui-input-block" id="IsPurchased">
				<input type="text" style="display:none" class="isDns">
		    	<input type="radio" name="isDns" value="0" title="0" checked="">
		    	<input type="radio" name="isDns" value="1" title="1">
		    </div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<div class="layui-input-block">
...
<script type="text/javascript" src="UrlLimitList.js"></script>
</body>
</html>