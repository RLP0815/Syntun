...
<title>data_table_filed_list</title>
...
<div class="layui-tab layui-tab-brief">
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>data_table_filed_list说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">filed_name</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input filedName" lay-verify="required" placeholder="请输入filed_name">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">filed_data_type</label>
			<div class="layui-input-block" id="IsPurchased">
				<input type="text" style="display:none" class="filedDataType">
		    	<input type="radio" name="filedDataType" value="1" title="1" checked="">
		    	<input type="radio" name="filedDataType" value="2" title="2">
		    </div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">default_value</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input defaultValue" lay-verify="required" placeholder="请输入default_value">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">filed_data_fun</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input filedDataFun" lay-verify="required" placeholder="请输入filed_data_fun">
			</div>
		</div>
...
<script type="text/javascript" src="DataTableFiledList.js"></script>
</body>
</html>