			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入URL" />
					</div>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">url_str</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input urlStr" lay-verify="required" placeholder="请输入url_str">
		<!-- 不能输入双字节字符设置
	onpaste="return false" ondragenter="return false"  onkeyup="this.value=this.value.replace(/[^\x00-\x80]/gi,'')"
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">pattern_table</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input patternTable" lay-verify="required" placeholder="请输入pattern_table">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">url_status</label>
			<div class="layui-input-block" id="IsPurchased">
				<input type="text" style="display:none" class="urlStatus">
		    	<input type="radio" name="urlStatus" value="0" title="0" checked="">
		    	<input type="radio" name="urlStatus" value="1" title="1">
		    </div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">url_data</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input urlData" lay-verify="required" placeholder="请输入url_data">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">url_charset</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input urlCharset" lay-verify="required" placeholder="请输入url_charset">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
...
<script type="text/javascript" src="InitUrlList.js"></script>
</body>
</html>