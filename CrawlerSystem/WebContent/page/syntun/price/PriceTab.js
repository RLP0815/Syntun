    ...
    function addPrice(edit){
    	...
    	var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                	body.find(".id").val(edit.id);  
                	body.find(".platformId").val(edit.platformId);
                    body.find(".promotionTypeName").val(edit.promotionTypeName);
                    body.find(".promotionPrice").val(edit.promotionPrice); 
       ...
       element.tabChange('filter', '00'); //切换到
       */
    }
