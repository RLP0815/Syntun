...
<body>
	...
	<input type="text" style="display:none" class="cxglId">
	<input type="text" style="display:none" class="tscxId">
						  ...
						  促销类型：
							<div class="layui-inline">
								<div class="layui-input-inline">
									<input type="text" class="layui-input searchValRank" placeholder="请输入促销类型" />
								</div>
								<a class="layui-btn search_btn_rank" data-type="reload">搜索</a>
								<a class="layui-btn layui-btn-normal add_btn_rank" data-type="reload">增加</a>
								<security:authorize ifAnyGranted="ROLE_DEL,ROLE_ADMIN">
								<a class="layui-btn layui-btn-danger delAll_btn_rank" data-type="reload">批量删除</a>
								</security:authorize>
					 		</div>
				 		</div>
					</blockquote>
					<table id="rankList" lay-filter="rankList"></table>
				</div>
				<script type="text/html" id="rankListBar">
					<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
					<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del">删除</a>
				</script>
	
				<div class="layui-col-md3 layui-col-xs12">
					<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>促销归类说明</blockquote>
				...
				<div id="rankTab" style="display:none;">
					<form class="layui-form" style="width:95%;">
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">抓取促销类型</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input oldPromotionTypeName"  placeholder="请输入促销类型">
							</div>
						</div>
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">抓取促销详情</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input oldPromotionTypeInfo1" placeholder="请输入促销详情">
								或
								<input type="text" class="layui-input oldPromotionTypeInfo2" placeholder="请输入促销详情">
							</div>
						</div>
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">修改促销类型</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input newPromotionTypeName" lay-verify="required" placeholder="请输入促销类型">
							</div>
						</div>
						<div class="layui-form-item layui-row layui-col-xs12">
							<div class="layui-input-block">
								<button class="layui-btn layui-btn-sm addFiledRank" lay-submit="" lay-filter="addFiledRank">立即添加</button>
								<button class="layui-btn layui-btn-sm editFiledRank" lay-submit="" lay-filter="editFiledRank">立即修改</button>
					...
					<blockquote class="layui-elem-quote quoteBox">
						<div class="demoTable">
						  促销内容：
							<div class="layui-inline">
								<div class="layui-input-inline">
									<input type="text" class="layui-input searchValSpe" placeholder="请输入促销内容" />
								</div>
								<a class="layui-btn search_btn_spe" data-type="reload">搜索</a>
								<a class="layui-btn layui-btn-normal add_btn_spe" data-type="reload">增加</a>
								<security:authorize ifAnyGranted="ROLE_DEL,ROLE_ADMIN">
								<a class="layui-btn layui-btn-danger delAll_btn_spe" data-type="reload">批量删除</a>
								</security:authorize>
					 		</div>
				 		</div>
					</blockquote>
					<table id="promotionSpecial" lay-filter="promotionSpecial"></table>
				</div>
				<script type="text/html" id="promotionSpecialBar">
					<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
					<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del">删除</a>
				</script>
	
				<div class="layui-col-md3 layui-col-xs12">
					<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>特殊促销说明</blockquote>
					<div class="border category">
						<div class="">
							<ul class="uullspecial">
					...
					<form class="layui-form" style="width:95%;">
						<div class="layui-row">
							<div class="magb15 layui-col-md4 layui-col-xs12">
								...
								<div class="layui-input-block">
									<input type="text" disabled="disabled" class="layui-input platformIdS" lay-verify="required" placeholder="请选择平台">
								</div>
							</div>
							<div class="magb15 layui-col-md4 layui-col-xs12">
								<label class="layui-form-label">平台名称</label>
								<div class="layui-input-block">
									<input type="text" disabled="disabled" class="layui-input platformNameS" lay-verify="required" placeholder="请选择平台">
								</div>
							</div>
							<div class="magb15 layui-col-md4 layui-col-xs12">
								<div class="layui-input-block">
									<a class="layui-btn layui-btn-normal selectPlatformS">平台选择</a>
								</div>
							</div>
						</div>
						
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">促销内容</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input promotionInfo" lay-verify="required" placeholder="请输入促销内容">
							</div>
						</div>
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">第一种促销</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input promotionFirst" lay-verify="required" placeholder="请输入第一种促销">
							</div>
						</div>
						<div class="layui-form-item layui-row layui-col-xs12">
							<label class="layui-form-label">第二种促销</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input promotionSecond" placeholder="请输入第二种促销">
							</div>
						</div>
						
						<div class="layui-form-item layui-row layui-col-xs12">
							<div class="layui-input-block">
								<button class="layui-btn layui-btn-sm addFiledSpe" lay-submit="" lay-filter="addFiled">立即添加</button>
								<button class="layui-btn layui-btn-sm editFiledSpe" lay-submit="" lay-filter="editFiled">立即修改</button>
								<!-- <button class="layui-btn layui-btn-sm" lay-filter="cancelFlied">取消</button> -->
							</div>
						</div>
					</form>
				</div>
				<div id="platformSpe" style="display:none;">
					<table id="platformListS" lay-filter="platformListS"></table>
					<script type="text/html" id="platformListSBar">
					...
					<form class="layui-form" style="width:95%;">
						<div class="layui-form-item layui-row layui-col-xs12">
							...
							<div class="layui-input-block  layui-form" lay-filter="selFilter">
								<select class="promotionType" lay-verify="required">
