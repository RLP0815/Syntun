...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入统一字段" />
					</div>
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>字段替换说明</blockquote>
...
<script type="text/javascript" src="FiledReplace.js"></script>
</body>
</html>