...
public class SkyscopeInspectUser {
	...
	public static void main(String[] args) {
		// 数据日期
		String dateStr = "2018-11-20";
		String hour = "14";
		String min = "15";
		String groupId = "5";
		String userId = "100693";
		String userName = "合生元";
		String email = "liping.ren@syntun.com";
		SkyscopeInspectUser.getResult(dateStr, hour, min, groupId, userId, userName, email);
		System.exit(0);
		// 读取结果表的字段列表
//		List<String> fieldList = BaseDaoSqlServer.getField16("PATROL_INSPECTION_LIST_HALF_COPY");
...
//		String getDateBak = getDate;
//		try {
//			Date date = new Date(df.parse(getDate).getTime() + 30*60*1000);
//			getDateBak = df.format(date);
//		} catch (ParseException e1) {
//			e1.printStackTrace();
//		}
...
//		HashMap<String, List<String>> skuUserList = BaseDaoSqlServer.getAllTbaleSkuUserListBak("[skyscope_temp].[dbo].[SKYSCOPE_PRICE_BAK]", filterUP, conn16);
		...
		filter.put("min", min);
		//filter.put("operation_product_id", "1511084");
		// 读取价格
...
//				.getTbaleAllData16("[skyscope].[dbo].[PRICE_PRODUCT_LIST_half_copy]", filter, keyList1, conn16);
		HashMap<String, List<HashMap<String, String>>> priceData = BaseDaoSqlServer
				.getTbaleAllData16("syntun_v2.PRICE_PRODUCT_LIST_HALF", filter, keyList1, conn138);
...
//				.getTbaleAllData16("[skyscope].[dbo].[PRICE_PROMOTION_INFO_half_copy]", filter, keyList, conn16);
		HashMap<String, List<HashMap<String, String>>> promotionData = BaseDaoSqlServer
				.getTbaleAllData16("syntun_v2.PRICE_PROMOTION_INFO_half", filter, keyList, conn138);
...
//		List<String> xiajiaFiledList = BaseDaoSqlServer.getField16("[skyscope_temp].[dbo].[xiajiabiao_total_copy]", "192.168.0.16", "skyscope_temp");
		...
		// 读取结果表的字段列表
		//List<String> fieldList = BaseDao.getField("skyscope_etl.price_result", conn60);
		// 读取结果表的字段列表
		//List<String> fieldList = BaseDaoSqlServer.getField16("PATROL_INSPECTION_LIST_HALF_COPY");
		...
		// 读取结果表的字段列表
		//List<String> fieldListNestle = BaseDaoSqlServer.getField16("PATROL_INSPECTION_LIST_HALF_NESTLE_COPY");
