...
<div class="layui-tab layui-tab-brief">
			...
			<div class="layui-inline">
				<div class="demoTable">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input searchVal" placeholder="请输入错误类型名称" />
					</div>
					<a class="layui-btn search_btn" data-type="reload">搜索</a>
					<!-- <a class="layui-btn layui-btn-normal add_btn" data-type="reload">增加</a> -->
					<a class="layui-btn layui-btn-danger delAll_btn" data-type="reload">清空记录</a>
				</div>
			</div>	
		</blockquote>
		<table id="errResultList" lay-filter="errResultList"></table>
	</div>
	<!--操作-->
	...
	<div class="layui-col-md3 layui-col-xs12">
		<blockquote class="layui-elem-quote title"><i class="seraph icon-caidan"></i>抛出错误说明</blockquote>
...
<div id="addFiled" style="display:none;">
	<form class="layui-form" style="width:90%;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">原字段</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input oldFiled" lay-verify="required" placeholder="请输入替换字段">
		不能输入双字节字符设置
	onpaste="return false" ondragenter="return false"  onkeyup="this.value=this.value.replace(/[^\x00-\x80]/gi,'')"
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">统一字段</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input unityFiled" lay-verify="required" placeholder="请输入统一字段">
			</div>
		</div>
...
<script type="text/javascript" src="ErrResult.js"></script>
</body>
</html>