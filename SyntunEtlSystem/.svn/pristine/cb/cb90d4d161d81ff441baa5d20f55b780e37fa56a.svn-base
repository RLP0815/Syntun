...
public class categoryCollect extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new categoryCollect(), args);
		System.exit(res);
	}
...
//		}
		...
		String input = "/tmp/SyntunCommentResultOut/Category/out/*";
		...
		Job job = new Job(conf, "categoryOut job");
		job.setJarByClass(categoryCollect.class);
