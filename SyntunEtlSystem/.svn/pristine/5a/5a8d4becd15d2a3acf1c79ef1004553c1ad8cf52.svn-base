...
public class priceAvgCollect extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new priceAvgCollect(), args);
		System.exit(res);
	}
	...
	public int run(String[] arg0) throws Exception {
		...
		//计算单年价格汇总
		String input = "/tmp/SyntunUser/";
		//String input = "/tmp/SyntunPriceAvg/";
		String output = "/tmp/SyntunPriceAvg/" + beginEnd;
		...
		Job job = new Job(conf, "priceAvg job");
		job.setJarByClass(priceAvgCollect.class);
