...
public class categoryGradeCollect extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new categoryGradeCollect(), args);
		System.exit(res);
	}
...
//		}
		...
		String input1 = "/tmp/SyntunCommentResultOut/Category/all_day/*";
		String input2 = "/tmp/SyntunBase/priceRangNumber/*";
		...
		Job job = new Job(conf, "categoryGrade job");
		job.setJarByClass(categoryGradeCollect.class);
