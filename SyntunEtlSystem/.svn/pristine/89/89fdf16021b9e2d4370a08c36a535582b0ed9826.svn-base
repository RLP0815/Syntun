...
public class resultHiveCollect extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new resultHiveCollect(), args);
		System.exit(res);
	}
	...
	public int run(String[] arg0) throws Exception {
		if (arg0.length < 3) {
			System.out.println("Please tell me input and Number of parameters and output!");
			System.exit(0);
		}
		...
		String input = arg0[0] + "/*";
		String output = arg0[2];
		int num = 0;
		try {
			num = Integer.parseInt(arg0[1]);
		} catch (Exception e) {
			System.out.println("Please tell me right Number of parameters!");
			System.exit(0);
		}
		...
		Job job = new Job(conf, "resultHive job");
		job.setJarByClass(resultHiveCollect.class);
