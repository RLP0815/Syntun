...
public class result6WCollect extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new result6WCollect(), args);
		System.exit(res);
	}
	...
	public int run(String[] arg0) throws Exception {
		...
		String input = "/tmp/SyntunComment/";
		String output = "/tmp/SyntunCommentResult48W/" + beginEnd;
		...
		Job job = new Job(conf, "commentResult48W job");
		job.setJarByClass(result6WCollect.class);
